...
<script>
  ...
  export default {
    ...
    //This determines to display the patient form or the medical
    //professional form
    props: ['patientForm'],
    components: {
    ...
    data () {
      return {
        ...
        //The warning message upon displaying if something went wrong with input fields or 
        //submitting the data
        showWarning: false,
        warning: '',
        //These are the input requirements as specified for our business rules to display for the
        //tool tips
        nameRequirements:'1 - 30 characters [A-Z or a - z and any special characters] ',
        usernameRequirements:`Has to be 8 - 120 characters [A - Z or a - z and any special characters] and
                              No spaces`,
        passwordRequirements:`Has to be 8 - 120 characters [A - Z or a - z and any special characters] and
                              No spaces`,
    ...
    computed:{
      ...
      //This resets the registration form upon an event that wants to reset
      //the form
      detectNewForm(){
    ...
    methods: {
      ...
      //This routes the user to the Medical Account Page after they sign in
